...
export default function Portfolio() {
	return (
		<section
			id='portfolio'
			className='flex flex-col-reverse lg:flex-row lg:items-center w-full gap-20 py-20'
		>
			...
			<div className='text-left w-full lg:w-6/12'>
				...
				<div className='flex flex-col py-16 gap-8'>
					<h3 className='text-indigo-600 font-bold text-3xl leading-tight'>
					...
					<p className='text-md leading-relaxed'>
						...
						analysis. leverages{" "}
						<span className='font-semibold italic text-indigo-600'>OpenAI</span>
						,{" "}
